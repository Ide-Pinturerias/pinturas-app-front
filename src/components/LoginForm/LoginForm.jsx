      ...
      <div className="relative sm:max-w-sm w-full">
        ...
        <div className="relative w-full rounded-3xl  px-16 py-5 bg-gray-100 shadow-md">
          ...
          <form
            ...
            className="data-[loading=true]:opacity-10 relative"
            data-loading={isLoading}
          >
            <div>
              <input
                ...
                className={`mt-1 p-2 text-center block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0 ${
          ...
          <p className="text-gray-400 mt-6 text-center">
            ...
            <PlainNavLink path="/login/register" className="ml-1 hover:text-white">
              Regístrate
            </PlainNavLink>
          </p>
        </div>
